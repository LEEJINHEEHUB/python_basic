...
# List Comprehensions (위에 것을 이것처럼 단축한 것임) 굉장히 중요!
...
my_list = [w+str(1) for w in words]
print(my_list)
...
print(enumerate(word), type(enumerate(word)))
...
result = [val for val in zip(my_list1, my_list2, my_list3)]
print(result)
